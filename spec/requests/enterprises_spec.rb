...
RSpec.describe "/enterprises", type: :request do
  ...
  # EnterprisesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get enterprises_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new Enterprise" do
        expect {
          post enterprises_url,
               params: { enterprise: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Enterprise" do
        expect {
          post enterprises_url,
               params: { enterprise: invalid_attributes }, as: :json
